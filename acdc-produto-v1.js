/* ACDC CASA — ACDC PRODUTO V1 — 24/07/2026
   Arquivo único versionado para a Nuvemshop.
   Inclui descrição flexível por negritos, transição, calculadora,
   voltar ao topo, produtos sob consulta e WhatsApp.
*/

/* =========================================================================
   ACDC CASA — PÁGINA DE PRODUTO (arquivo único)
   versão do arquivo: v1
